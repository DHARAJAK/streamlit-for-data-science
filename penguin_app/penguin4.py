...
st.markdown("Use this Streamlit app to make your own scatterplot about Penguin palmers")
penguin_file = st.file_uploader("Selce your local Penguisn CSV (default provided)")
